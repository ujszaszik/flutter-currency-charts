...
import 'package:currency_charts/features/chartrates/bindings/chart_rates_bindings.dart';
...
class Routes {
  static List<GetPage> all() {
    return [
      ...
      GetPage(
          name: ChartRatesScreen.route,
          page: () => const ChartRatesScreen(),
          binding: ChartRatesBindings())
    ];
  }
}
